...
import com.br.falemaisapi.model.entity.TaxRate;
...
import static com.br.falemaisapi.util.JsonUtil.*;
...
class PlanControllerTest {
    ...
    void setUp() {
        ...
        Plan plan30 = new Plan(1L, 30, "FaleMais 30", taxRate);
        Plan plan60 = new Plan(2L, 60, "FaleMais 60", taxRate);
        Plan plan120 = new Plan(3L, 120, "FaleMais 120", taxRate);
